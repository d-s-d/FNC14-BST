...
void* bst_alloc_108_root_opt( size_t n ) {
...
double bst_compute_108_root_opt( void*_bst_obj, double* p, double* q, size_t n ) {
...
size_t bst_get_root_108_root_opt( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_108_root_opt( void* _mem ) {
