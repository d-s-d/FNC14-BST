...
void* bst_alloc_133_132_rescheduled( size_t n ) {
...
double bst_compute_133_132_rescheduled( void*_bst_obj, double* p, double* q, size_t nn ) {
    ...
    for (i = n-1; i >= 0; --i) {
        ...
        for (r = i; r < n; ++r) {
            ...
            for (; j < (n+1-15); j += 16, idx_rj += 16, idx_ij += 16) {
                ...
                // instruction scheduling as in 129
                ...
                __m256d u1_t1_1 = _mm256_add_pd(e_ir, u1_w_ij1);
                __m256d u1_e_rj2 = _mm256_load_pd(e + idx_rj + 4);
                __m256d u1_t2_1 = _mm256_add_pd(e_ir, u1_w_ij2);
                __m256d u2_e_rj1 = _mm256_load_pd(e + idx_rj + 8);
                __m256d u2_t1_1 = _mm256_add_pd(e_ir, u2_w_ij1);
                __m256d u2_e_rj2 = _mm256_load_pd(e + idx_rj + 12);
                __m256d u2_t2_1 = _mm256_add_pd(e_ir, u2_w_ij2);

                __m256d u1_t1   = _mm256_add_pd(u1_t1_1, u1_e_rj1);
                __m256d u1_e_ij1 = _mm256_load_pd(e + idx_ij + 0);
                __m256d u1_t2   = _mm256_add_pd(u1_t2_1, u1_e_rj2);
                __m256d u1_e_ij2 = _mm256_load_pd(e + idx_ij + 4);
                __m256d u2_t1   = _mm256_add_pd(u2_t1_1, u2_e_rj1);
                __m256d u2_e_ij1 = _mm256_load_pd(e + idx_ij + 8);
                __m256d u2_t2   = _mm256_add_pd(u2_t2_1, u2_e_rj2);
...
size_t bst_get_root_133_132_rescheduled( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_133_132_rescheduled( void* _mem ) {
...
size_t bst_flops_133_132_rescheduled( size_t n ) {
    size_t n3 = n*n*n;
    size_t n2 = n*n;
