...
void* bst_alloc_111_init_opt_nontransp( size_t n ) {
...
double bst_compute_111_init_opt_nontransp( void*_bst_obj, double* p, double* q, size_t n ) {
...
size_t bst_get_root_111_init_opt_nontransp( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_111_init_opt_nontransp( void* _mem ) {
...
size_t bst_flops_111_init_opt_nontransp( size_t n ) {
    size_t n3 = n*n*n;
    size_t n2 = n*n;
