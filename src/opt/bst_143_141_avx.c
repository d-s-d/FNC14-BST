...
void* bst_alloc_143_141_avx( size_t n ) {
...
size_t bst_get_root_143_141_avx( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_143_141_avx( void* _mem ) {
...
size_t bst_flops_143_141_avx( size_t n ) {
    size_t n3 = n*n*n;
    size_t n2 = n*n;
