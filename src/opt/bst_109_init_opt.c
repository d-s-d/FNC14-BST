...
void* bst_alloc_109_init_opt( size_t n ) {
...
double bst_compute_109_init_opt( void*_bst_obj, double* p, double* q, size_t n ) {
...
size_t bst_get_root_109_init_opt( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_109_init_opt( void* _mem ) {
...
size_t bst_flops_109_init_opt( size_t n ) {
    size_t n3 = n*n*n;
    size_t n2 = n*n;
