...
void* bst_alloc_121_m128_aligned4( size_t n ) {
...
size_t bst_get_root_121_m128_aligned4( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_121_m128_aligned4( void* _mem ) {
...
size_t bst_flops_121_m128_aligned4( size_t n ) {
    double n3 = n*n*n;
    double n2 = n*n;
