...
void* bst_alloc_127_m256_maskstore( size_t n ) {
...
double bst_compute_127_m256_maskstore( void*_bst_obj, double* p, double* q, size_t nn ) {
...
size_t bst_get_root_127_m256_maskstore( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_127_m256_maskstore( void* _mem ) {
...
size_t bst_flops_127_m256_maskstore( size_t n ) {
    double n3 = n*n*n;
    double n2 = n*n;
