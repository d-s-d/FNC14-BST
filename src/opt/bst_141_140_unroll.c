...
void* bst_alloc_141_140_unroll( size_t n ) {
...
#endif
double bst_compute_141_140_unroll( void*_bst_obj, double* p, double* q, size_t nn ) {
...
size_t bst_get_root_141_140_unroll( void* _bst_obj, size_t i, size_t j )
{
...
void bst_free_141_140_unroll( void* _mem ) {
...
size_t bst_flops_141_140_unroll( size_t n ) {
    size_t n3 = n*n*n;
    size_t n2 = n*n;
